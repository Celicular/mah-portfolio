  ...
  return (
    <div className="min-h-screen bg-[#09090b] flex flex-col items-center justify-center p-4 font-sans text-white">
      <div className="w-full max-w-md bg-[#111113] p-8 rounded-2xl border border-white/10 shadow-2xl">
        <div className="w-12 h-12 bg-sky-600/20 rounded-xl flex items-center justify-center mb-6 border border-sky-500/30">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          <input
            ...
            className="w-full bg-black/50 border border-white/10 rounded-xl px-4 py-3 text-white placeholder-white/30 focus:outline-none focus:border-sky-500 focus:ring-1 focus:ring-sky-500 transition-all"
            autoFocus
          />
          <button
            type="submit"
